defmodule Canary.Repo.Migrations.CreateTables do
  ...
  def change do
    ...
    # --- Oban Jobs (Lite engine) ---
    # Oban.Engines.Lite expects this table to exist before startup.
    # Cannot use Oban.Migrations.SQLite — its migration behaviour is
    # incompatible with Ecto.Migrator.run. Raw SQL in Release GenServer
    # races with pool_size:1. Putting it here runs in the migration
