...
- [ ] Given the flow is completed for a sample service, when the operator opens `/api/v1/report` and the dashboard, then the new service appears without extra setup steps
