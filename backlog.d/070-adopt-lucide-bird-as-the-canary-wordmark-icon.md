# Adopt Lucide bird as the canary wordmark icon

Priority: P2 · Status: open · Estimate: S

## Goal

Adopt the Lucide `bird` icon as the canonical wordmark/logo for
canary — production health — the early warning, agent-first command center.
...
- [ ] The `bird` Lucide icon is rendered in the repo's primary
...
- Lucide icon: https://lucide.dev/icons/bird
